...
public class AgeHistory4
{
	...
	// The main method: get argument and calls printAgeHistory.
	public static void main(String [] args)
	{
		// The year of the present day.
		int presentYear = Integer.parseInt(args[0]);

		// The four birth years, which must be less than present year.
