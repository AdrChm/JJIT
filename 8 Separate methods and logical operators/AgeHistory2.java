...
public class AgeHistory2
{
	public static void main(String [] args)
	{
		...
		// Now we will go through between birth and last year.
		int someYear = birthYear1 + 1;
		int ageInSomeYear = 1;

		while (someYear != presentYear)
		{
			System.out.println("Pn 1 was " + ageInSomeYear + " in " + someYear);
			someYear++;
			ageInSomeYear++;
		} // while

		// Finally, the age of the person this year.
		System.out.println("Pn 1 is " + ageInSomeYear + " this year ");		
